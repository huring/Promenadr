...
@interface PromenadrObject : KrollCoverageObject {
#else
@interface PromenadrObject : KrollObject {
#endif
@private
...
extern NSString * Promenadr$ModuleRequireFormat;
