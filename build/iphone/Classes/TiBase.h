...
// in simulator we redefine to format for Promenadr Developer console
...
{\
	NSString * exceptionName = [@"org.promenadr." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.promenadr";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPromenadrNativeItemNone = -1, 
	UIPromenadrNativeItemSpinner = -2,
	UIPromenadrNativeItemProgressBar = -3,
	
	UIPromenadrNativeItemSlider = -4,
	UIPromenadrNativeItemSwitch = -5,
	UIPromenadrNativeItemMultiButton = -6,
	UIPromenadrNativeItemSegmented = -7,
	
	UIPromenadrNativeItemTextView = -8,
	UIPromenadrNativeItemTextField = -9,
	UIPromenadrNativeItemSearchBar = -10,
	
	UIPromenadrNativeItemPicker = -11,
	UIPromenadrNativeItemDatePicker = -12,
	
	UIPromenadrNativeItemInfoLight = -13,
	UIPromenadrNativeItemInfoDark = -14,
	
	UIPromenadrNativeItemDisclosure = -15,
	
	UIPromenadrNativeItemContactAdd = -16
};
