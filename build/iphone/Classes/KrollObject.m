 ...
 * Copyright (c) 2009-2011 by Promenadr, Inc. All Rights Reserved.
...
//@interface PromenadrObject : NSObject
//@end

@interface PromenadrObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PromenadrObject class]])
		{
			for (NSString *key in [[(PromenadrObject*)o modules] allKeys])
			{
