...
instance.add(updatedLocationTime);
	...
	button.addEventListener('click', function(e) {
		...
		Ti.Geolocation.getCurrentPosition(function(e) {
			...
			Ti.API.info('geo - current location: long ' + globals.geodata.longitude + ' lat ' + globals.geodata.latitude + ' accuracy ' + globals.geodata.accuracy);
		...
		Ti.Geolocation.addEventListener('location', function(e) {
			...
			Ti.API.info('geo - location updated: ' + new Date(globals.geodata.timestamp) + ' long ' + globals.geodata.longitude + ' lat ' + globals.geodata.latitude + ' accuracy ' + globals.geodata.accuracy);
